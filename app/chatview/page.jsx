...
import ChatInit from "../components/chat/chatinti";
  ...
  return (
    ...
    >
      ...
      <SidebarInset>
        ...
        <div className="mx-auto w-full flex flex-1 flex-col gap-4   justify-between h-screen text-base md:gap-3 lg:gap-3 md:max-w-3xl">
          <ChatInit />
