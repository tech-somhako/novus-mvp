...
import JobProfile from "../components/chat/JobProfile";
import CandidateCard from "@/components/common/profile/CandidateCard";
      ...
      <SidebarInset>
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-7 bg-gray-50 gap-3">
            ...
            <div className="px-3">
              <h5 className="pb-3">Candidate Profiling </h5>
