  ...
  return (
    ...
    >
      ...
      <SidebarInset>
            ...
            <div>
              ...
              <Button variant="ghost" className="p-3">
                ...
                {/* <Button
                  ...
                  className="text-sm font-medium hover:bg-gray-200 px-4 py-2"
                >
                  New Chat
                </Button> */}
                  <Avatar>
        ...
        <div className=" mx-auto flex flex-1 flex-col justify-between h-screen gap-4 text-base md:gap-3 lg:gap-3 md:max-w-3xl max-h-max">
          <ChatView messages={messages} />

          <div className="fixed z-10 mx-auto bottom-0 inset-x-0 flex shrink-0 items-center z-10 justify-center gap-2 bg-background py-2 px-4">
            <div className="mx-auto flex flex-1 flex-col gap-4 text-base md:gap-3 lg:gap-3 md:max-w-3xl">
