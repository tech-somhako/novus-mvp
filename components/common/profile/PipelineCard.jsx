...
import { Chart08, ChartCareer } from "@/app/components/chat/chart";
...
export default function PipelineCard() {
  ...
  return (
    <>
      <Card className="border-b-0 border-t-4 border-l-0 border-r-0 border-blue-600">
        ...
        <CardContent className="px-3 pb-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-blue-700 m-0">Career</p>
            </div>
