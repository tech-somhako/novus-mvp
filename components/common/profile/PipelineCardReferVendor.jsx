...
import { Chart07, Chart08, ChartVendor } from "@/app/components/chat/chart";
import { Dot } from "lucide-react";

export default function PipelineCardVendor() {
  ...
  return (
    <>
      <Card className="border-b-0 border-t-4 border-l-0 border-r-0 border-green-600">
        ...
        <CardContent className="px-3 pb-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-green-700 m-0">Vendor</p>
            </div>
